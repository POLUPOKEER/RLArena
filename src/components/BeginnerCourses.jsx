...
import { BEGINNER_COURSES_LIST } from "../helpers/courses";
...
const BeginnerCourses = () => {
  ...
  const nextSlide = () => {
    setCurrentIndex((prevIndex) =>
      Math.min(prevIndex + 1, BEGINNER_COURSES_LIST.length - maxVisible)
    );
  };
      ...
      <div className="flex flex-col w-full max-w-6xl">
        <div className="flex justify-end max-w-5xl mb-4 ml-16">
          ...
          <button
            ...
            disabled={
              currentIndex === BEGINNER_COURSES_LIST.length - maxVisible
            }
          >
        ...
        <div className="flex justify-center mt-4 gap-2 mr-[60px]">
          {BEGINNER_COURSES_LIST.slice(0, BEGINNER_COURSES_LIST.length - 2).map((_, index) => (
            <div
              key={index}
